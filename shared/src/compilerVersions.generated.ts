...
export type CompilerPackageNames = "typescript-4.5.4" | "typescript-4.4.4" | "typescript-4.3.5" | "typescript-4.2.4" | "typescript-4.1.5" | "typescript-4.0.5" | "typescript-3.9.7" | "typescript-3.8.3" | "typescript-3.7.5" | "typescript-3.6.4";
export type CompilerVersions = "4.5.4" | "4.4.4" | "4.3.5" | "4.2.4" | "4.1.5" | "4.0.5" | "3.9.7" | "3.8.3" | "3.7.5" | "3.6.4";
export const compilerVersionCollection: { version: CompilerVersions; packageName: CompilerPackageNames; }[] = [
        { version: "4.5.4", packageName: "typescript-4.5.4" },
