...
export { default as export32 } from "./lib.es2019.string";
export { default as export33 } from "./lib.es2019.symbol";
export { default as export34 } from "./lib.es5";
export { default as export35 } from "./lib.es6";
export { default as export36 } from "./lib.esnext.array";
export { default as export37 } from "./lib.esnext.asynciterable";
export { default as export38 } from "./lib.esnext.bigint";
export { default as export39 } from "./lib.esnext";
export { default as export40 } from "./lib.esnext.full";
export { default as export41 } from "./lib.esnext.intl";
export { default as export42 } from "./lib.esnext.symbol";
export { default as export43 } from "./lib.scripthost";
export { default as export44 } from "./lib.webworker";
export { default as export45 } from "./lib.webworker.importscripts";
