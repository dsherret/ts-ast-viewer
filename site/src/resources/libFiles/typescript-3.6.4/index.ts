...
export { default as export36 } from "./lib.es2020";
export { default as export37 } from "./lib.es2020.full";
export { default as export38 } from "./lib.es2020.string";
export { default as export39 } from "./lib.es2020.symbol.wellknown";
export { default as export40 } from "./lib.es5";
export { default as export41 } from "./lib.es6";
export { default as export42 } from "./lib.esnext.array";
export { default as export43 } from "./lib.esnext.asynciterable";
export { default as export44 } from "./lib.esnext.bigint";
...
export { default as export48 } from "./lib.esnext.symbol";
export { default as export49 } from "./lib.scripthost";
export { default as export50 } from "./lib.webworker";
export { default as export51 } from "./lib.webworker.importscripts";
