...
export { default as export41 } from "./lib.es2020.sharedmemory";
export { default as export42 } from "./lib.es2020.string";
export { default as export43 } from "./lib.es2020.symbol.wellknown";
export { default as export44 } from "./lib.es2021";
export { default as export45 } from "./lib.es2021.full";
export { default as export46 } from "./lib.es2021.intl";
export { default as export47 } from "./lib.es2021.promise";
export { default as export48 } from "./lib.es2021.string";
export { default as export49 } from "./lib.es2021.weakref";
export { default as export50 } from "./lib.es5";
export { default as export51 } from "./lib.es6";
export { default as export52 } from "./lib.esnext";
export { default as export53 } from "./lib.esnext.full";
export { default as export54 } from "./lib.esnext.intl";
export { default as export55 } from "./lib.esnext.promise";
export { default as export56 } from "./lib.esnext.string";
export { default as export57 } from "./lib.esnext.weakref";
export { default as export58 } from "./lib.scripthost";
export { default as export59 } from "./lib.webworker";
export { default as export60 } from "./lib.webworker.importscripts";
export { default as export61 } from "./lib.webworker.iterable";
