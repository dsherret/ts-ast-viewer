...
import type { InternalSymbolName } from "../enums/internalSymbolName.enum.ts";
import type { LanguageVariant } from "../enums/languageVariant.enum.ts";
import type { NodeFlags } from "../enums/nodeFlags.enum.ts";
import type { ScriptKind } from "../enums/scriptKind.enum.ts";
