...
export {default as export25} from "./lib.es5";
export {default as export26} from "./lib.es6";
export {default as export27} from "./lib.esnext.array";
export {default as export28} from "./lib.esnext.asynciterable";
export {default as export29} from "./lib.esnext";
export {default as export30} from "./lib.esnext.full";
export {default as export31} from "./lib.esnext.promise";
export {default as export32} from "./lib.scripthost";
export {default as export33} from "./lib.webworker";
