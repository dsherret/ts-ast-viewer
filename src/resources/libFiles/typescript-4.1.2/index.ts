...
export { default as export44 } from "./lib.es5";
export { default as export45 } from "./lib.es6";
export { default as export46 } from "./lib.esnext";
export { default as export47 } from "./lib.esnext.full";
export { default as export48 } from "./lib.esnext.intl";
export { default as export49 } from "./lib.esnext.promise";
export { default as export50 } from "./lib.esnext.string";
export { default as export51 } from "./lib.esnext.weakref";
export { default as export52 } from "./lib.scripthost";
export { default as export53 } from "./lib.webworker";
export { default as export54 } from "./lib.webworker.importscripts";
export { default as export55 } from "./lib.webworker.iterable";
